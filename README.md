这里是 `zyxOT-v3`，如需 `v2` 的话，可前往 https://github.com/Hussein-01bit/zyxOT-v2 自取

# 以下内容为更新内容，请务必看完。
> 本次更新内容如下：
> 
> 1. 支持 bitxor，但请注意，不支持中文
> 2. 投食功能完善，但是不支持 C++ 了
> 3. 版本号更新为 `v3`
...
5. 点击完成（**无论您有没有 v1/v2 都请点击清除数据并部署，不然可能会有未知的问题**），会初始化 OT，并跳转至 OT 主页
